			...
			<body>
				<div>
					...
					<div id="isi3">
						...
						<br>
						<tr>
							<td class="indentasi" style="text-align: justify;">Keterangan</td>
							<td>:</td>
						</tr>
						<br></br>
						<tr>
							<td class="indentasi" style="text-align: justify;">
								Orang tersebut di atas benar-benar berdomisili
								<a style="text-transform: capitalize;">
									<?php echo "RT" . $row['rt'] . "/RW" . $row['rw'] . ", Dusun" . $row['dusun'] . ", Desa" . $row['desa'] . ", Kecamatan" . $row['kecamatan']; ?>
								</a>
							</td>
						</tr>
						<table width="100%">
							<tr>
								<td class="indentasi" style="text-align: justify;">
									...
									<a style="text-transform: capitalize;">
										<u><b><?php echo $row['keperluan']; ?></b></u>
									</a>
								</td>
							</tr>
						</table>
