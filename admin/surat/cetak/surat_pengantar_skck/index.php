			...
			<body>
				<div>
					...
					<div id="isi3">
						...
						<table width="100%">
							<td class="indentasi">Seorang tersebut diatas sesuai dengan pengamatan kami selama di Desa Pucangsari, adat istiadatnya baik dan tidak dalam urusan Kepolisian.
							</td>
							</tr>
						</table><br>
						<table width="100%">
