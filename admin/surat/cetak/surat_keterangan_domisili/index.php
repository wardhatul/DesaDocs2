...
?>
			...
			<body>
				<div>
					<table width="100%">
						<tr><img src="../../../../assets/img/logo pasuruan.png" alt="" class="logo"></tr>
						<div class="header">
							...
							<h4 class="kop" style="text-transform: uppercase">KANTOR DESA <?php echo $rows['nama_desa']; ?></h4>
							<h5 class="kop2" style="text-transform: capitalize;"><?php echo $rows['alamat'] . ' ' . $rows['kode_pos']; ?></h5>
					...
					<div id="isi3">
						...
						<table width="100%" style="text-transform: capitalize;">
							...
							<tr>
								...
								<td>:</td>
								<td><?php echo "RT" . $row['rt'] . "/RW" . $row['rw'] . ", Dusun " . $row['dusun'] . ", Desa " . $row['desa'] . ", Kecamatan " . $row['kecamatan'] . ", " . $row['kota']; ?></td>
							</tr>
							<tr>
						...
						<table width="100%">
							<tr>
								<td class="indentasi">Bahwa benar-benar penduduk kami Dusun <a style="text-transform: capitalize;"><?php echo $row['dusun']; ?>, Desa <?php echo $rows['nama_desa']; ?>, Kecamatan <?php echo $rows['kecamatan']; ?>, <?php echo $rows['kota']; ?></a>. Bahwa nama yang bersangkutan berdomisili di <a style="text-transform: capitalize;"><b><u><?php echo "RT" . $row['rt'] . "/RW" . $row['rw'] . ", Dusun " . $row['dusun'] . ", Desa " . $row['desa'] . ", Kecamatan " . $row['kecamatan'] . ", " . $row['kota']; ?></u></b></a>.</td>
							</tr>
						</table><br>
						<table width="100%">
							<tr>
