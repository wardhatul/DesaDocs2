					...
					<div class="col-md-12">
						<div class="card">
							...
							<div class="container-fluid">
								<div class="row">
									<a class="col-sm-6">
										<h5><b>SURAT KETERANGAN KEPEMILIKAN KENDARAAN BERMOTOR</b></h5>
									</a>
									<a class="col-sm-6">
							...
							<form method="post" action="simpan-surat.php">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div class="col-sm-12">
												<textarea type="text" name="falamat" class="form-control" style="text-transform: capitalize;" readonly><?php echo "RT" . $data['rt'] . "/RW" . $data['rw'] . ", Dusun " . $data['dusun'] . ",\nDesa " . $data['desa'] . ", Kecamatan " . $data['kecamatan'] . ", " . $data['kota']; ?></textarea>
											</div>
										</div>
									</div>
									<div class="col-sm-6">
								...
								<br>
								<h6 class="container-fluid" align="right"><i class="fas fa-edit"></i> Formulir Informasi Kendaraan</h6>
								<hr width="97%">
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
