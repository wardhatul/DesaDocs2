...
<body>
		...
		<navbar class="navbar navbar-expand-lg navbar-dark bg-transparent">
			...
			<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
				<ul class="navbar-nav ml-auto mt-lg-3 mr-5 position-relative text-right">
					...
					<li class="nav-item">
						<a class="nav-link" href="surat/"></i>&nbsp;<strong>BUAT SURAT</strong></a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="tentang/"></i>&nbsp;<strong>TENTANG <b>DesaDocs</b></strong></a>
					</li>
	...
	<div class="container" style="max-height:cover; padding-top:50px; padding-bottom:120px" align="center">
		<img src="assets/img/logo pasuruan.png" alt="Logo Pasuruan" style="width: 330px; height: 380px;">
		...
		?>
			<?php
			// Ganti nilai nama desa dan kota sesuai dengan yang Anda inginkan
			$namaDesa = "Pucangsari";
			$kota = "Kabupaten Pasuruan";
			?>

			<a class="text-light" style="font-size: 15pt; text-transform: uppercase;"><strong>DESA <?php echo $namaDesa; ?></strong></a><br>
			<a class="text-light" style="font-size: 15pt; text-transform: uppercase;"><strong><?php echo $kota; ?></strong></a>
			<hr>
